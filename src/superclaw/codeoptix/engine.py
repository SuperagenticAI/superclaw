...
from superclaw.adapters.base import AgentOutput, AgentAdapter
from superclaw.codeoptix.evaluator import SecurityEvaluator, SecurityEvaluationResult
...
class SecurityEngineResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "behaviors": {
                name: result.to_dict() 
                for name, result in self.behaviors.items()
            },
    ...
    def evaluate_security(
        ...
        for behavior_name in behavior_names:
            ...
            behavior_scenarios = [
                ...
                if s.get("behavior") == behavior_name
            ]
