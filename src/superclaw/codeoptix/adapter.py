...
if TYPE_CHECKING:
    ...
    from codeoptix.behaviors.base import BehaviorSpec as CodeOptixBehaviorSpec
    from codeoptix.adapters.base import AgentOutput as CodeOptixAgentOutput

from superclaw.behaviors import BEHAVIOR_REGISTRY, BehaviorSpec, BehaviorResult, Severity
...
def register_superclaw_behaviors() -> dict[str, type]:
    ...
    if not _codeoptix_available():
        raise RuntimeError(
            "CodeOptiX not installed. Install with: pip install codeoptix"
        )
